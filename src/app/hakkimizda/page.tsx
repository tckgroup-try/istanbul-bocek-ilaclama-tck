    ...
    <div className="pt-32 pb-24 overflow-hidden">
      ...
      <section className="relative mb-24">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel text-sm text-zinc-300 mb-6">
          ...
          <p className="text-xl text-zinc-400 max-w-3xl mx-auto leading-relaxed">
            TCK İlaçlama, TCK Group'un gücü ve vizyonuyla İstanbul'un her noktasına 7/24 ulaşan, teknolojik donanımlı profesyonel bir mobil haşere kontrol ordusudur. Biz hayal değil, sıfır böcek garantisi satarız.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-1/2">
              <div className="relative h-[500px] rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-zinc-900 via-transparent to-brand/20" />
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">Piyasadaki merdiven altı tarım ilaçlarını kullanmayız. Sadece insan ve çevre sağlığına duyarlı, uluslararası standartlarda "Biyosidal" ürünler kullanıyoruz.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">Evi barkı terk etmenize, günlerce cam çerçeve açmanıza gerek yok. Jel ve sıvı solüsyonlarımız zerre koku yapmaz, parkede veya duvarda iz bırakmaz.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">Evdeki kedin, köpeğin veya bebeğin için endişelenme abi. İlaçlarımız sadece soğukkanlı böceklerin sinir sistemini kilitler, sıcakkanlılara zarar vermez.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-400">Sıktığımız ilaç o an kurusa bile, içinde mikroskobik kapsüller barındırır. Böcek o yüzeyden aylar sonra geçse bile kapsül patlar ve işi bitirir. Domino etkisi yaratır.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-zinc-900/50 border-y border-white/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Özel Harekât Gibi Mobil Ekip</h2>
          <p className="text-xl text-zinc-400 max-w-3xl mx-auto mb-12">
            TCK Group araç filomuz, çağrıyı aldığınız an harekete geçer. Gece gündüz demeden, tam teçhizatlı tulumlarımız ve yüksek basınçlı ULV makinelerimizle mekandayız. Biz dükkana girerken komşu esnaf ne olduğunu anlamadan operasyonu bitirir, sessizce çıkarız.
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <p className="text-sm text-zinc-400">Fırın, restoran veya plaza. Sen üretimi durdurma, biz gece gelir hallederiz.</p>
            </div>
            <div className="glass-panel p-8 rounded-2xl">
              <h3 className="text-4xl font-bold text-brand mb-2">%100</h3>
              <p className="text-white font-medium mb-2">Garantili Çözüm</p>
              <p className="text-sm text-zinc-400">Böcek bitmedi mi? Ücretsiz olarak tekrar gelip kılıçtan geçiririz.</p>
            </div>
            <div className="glass-panel p-8 rounded-2xl">
              ...
              <p className="text-sm text-zinc-400">Körlemesine ilaç sıkmayız, önce böceğin yuvasını ve türünü analiz ederiz.</p>
            </div>
          </div>
        </div>
      </section>
